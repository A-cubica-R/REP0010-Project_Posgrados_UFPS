...
public enum OfertaacademicaInput {
        ...
        public record OFERTAACADEMICA_UPDATE(
                        @NotNull Integer id,
                        @NotNull Integer cupos,
                        @NotBlank String encuentros,
                        @NotNull Integer idPrograma,
        ...
        public record OFERTAACADEMICA_PATCH(
                        @NotNull Integer id,
                        String encuentros,
                        Integer idPrograma,
                        Integer idModalidad,
        ...
        public record OFERTAACADEMICA_DELETE(
                        @NotNull Integer id)
                        implements DeleteType {
        }

        public record OFERTAACADEMICA_FIND(
                        @NotNull Integer id)
                        implements FindType {
        }
        ...
        public record OFERTAACADEMICA_CREATE_WITH_PLAZO(
                        ...
                        @NotNull Integer idJornada,
                        @NotNull Integer idCohorte,
                        @NotNull PlazoInput.PLAZO_CREATE plazo)
                        implements CreateType {
        }
}
