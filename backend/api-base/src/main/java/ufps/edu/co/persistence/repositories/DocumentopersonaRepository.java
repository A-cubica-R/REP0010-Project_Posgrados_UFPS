...
/**
 * Spring Data JPA repository for the DocumentopersonaEntity entity.
 *
...
public interface DocumentopersonaRepository extends JpaRepository<DocumentopersonaEntity, Integer> {
	...
	//List<DocumentopersonaEntity> findByXxxStartingWith(String xxx);

	//List<DocumentopersonaEntity> findByXxxContaining(String xxx);

	//List<DocumentopersonaEntity> findByYyy(BigDecimal yyy);

	//List<DocumentopersonaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
