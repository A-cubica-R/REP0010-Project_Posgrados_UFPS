...
/**
 * Spring Data JPA repository for the TiporegistroEntity entity.
 *
...
public interface TiporegistroRepository extends JpaRepository<TiporegistroEntity, Integer> {
	...
	//List<TiporegistroEntity> findByXxx(String xxx);

	//List<TiporegistroEntity> findByXxxStartingWith(String xxx);

	//List<TiporegistroEntity> findByXxxContaining(String xxx);

	//List<TiporegistroEntity> findByYyy(BigDecimal yyy);

	//List<TiporegistroEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
