...
/**
 * Spring Data JPA repository for the ResultadopruebaEntity entity.
 *
 ...
 */
@Repository
public interface ResultadopruebaRepository extends JpaRepository<ResultadopruebaEntity, Integer> {

	// Insert specific finders here 

	//List<ResultadopruebaEntity> findByXxx(String xxx);

	//List<ResultadopruebaEntity> findByXxxStartingWith(String xxx);

	//List<ResultadopruebaEntity> findByXxxContaining(String xxx);

	//List<ResultadopruebaEntity> findByYyy(BigDecimal yyy);

	//List<ResultadopruebaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
