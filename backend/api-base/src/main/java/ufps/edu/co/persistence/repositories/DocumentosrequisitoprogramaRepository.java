...
/**
 * Spring Data JPA repository for the DocumentosrequisitoprogramaEntity entity.
 *
...
public interface DocumentosrequisitoprogramaRepository extends JpaRepository<DocumentosrequisitoprogramaEntity, Integer> {
	...
	//List<DocumentosrequisitoprogramaEntity> findByXxx(String xxx);

	//List<DocumentosrequisitoprogramaEntity> findByXxxStartingWith(String xxx);

	//List<DocumentosrequisitoprogramaEntity> findByXxxContaining(String xxx);

	//List<DocumentosrequisitoprogramaEntity> findByYyy(BigDecimal yyy);

	//List<DocumentosrequisitoprogramaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
