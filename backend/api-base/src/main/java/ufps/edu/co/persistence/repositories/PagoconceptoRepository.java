...
/**
 * Spring Data JPA repository for the PagoconceptoEntity entity.
 *
...
public interface PagoconceptoRepository extends JpaRepository<PagoconceptoEntity, Integer> {
	...
	//List<PagoconceptoEntity> findByXxxStartingWith(String xxx);

	//List<PagoconceptoEntity> findByXxxContaining(String xxx);

	//List<PagoconceptoEntity> findByYyy(BigDecimal yyy);

	//List<PagoconceptoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
