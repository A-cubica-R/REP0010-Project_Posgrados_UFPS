...
/**
 * Spring Data JPA repository for the AdmitidoEntity entity.
 *
...
public interface AdmitidoRepository extends JpaRepository<AdmitidoEntity, Integer> {
	...
	//List<AdmitidoEntity> findByXxx(String xxx);

	//List<AdmitidoEntity> findByXxxStartingWith(String xxx);

	//List<AdmitidoEntity> findByXxxContaining(String xxx);

	//List<AdmitidoEntity> findByYyy(BigDecimal yyy);

	//List<AdmitidoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
