...
/**
 * Spring Data JPA repository for the PagosEntity entity.
 *
...
public interface PagosRepository extends JpaRepository<PagosEntity, Integer> {
	...
	//List<PagosEntity> findByXxx(String xxx);

	//List<PagosEntity> findByXxxStartingWith(String xxx);

	//List<PagosEntity> findByXxxContaining(String xxx);

	//List<PagosEntity> findByYyy(BigDecimal yyy);

	//List<PagosEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
