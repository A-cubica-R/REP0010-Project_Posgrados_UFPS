/*
 * Created on 2026-05-28 ( 16:17:15 )
...
public class PersonaEntity implements Serializable {
    ...
    @Column(name="id_grupoetnico")
    private Integer    idGrupoetnico ;

    @Column(name="id_poblacionindigena")
    ...
    @Column(name="id_ubicacionvivienda")
