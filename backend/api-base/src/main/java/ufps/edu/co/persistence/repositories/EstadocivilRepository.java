...
/**
 * Spring Data JPA repository for the EstadocivilEntity entity.
 *
...
public interface EstadocivilRepository extends JpaRepository<EstadocivilEntity, Integer> {
	...
	//List<EstadocivilEntity> findByXxx(String xxx);

	//List<EstadocivilEntity> findByXxxStartingWith(String xxx);

	//List<EstadocivilEntity> findByXxxContaining(String xxx);

	//List<EstadocivilEntity> findByYyy(BigDecimal yyy);

	//List<EstadocivilEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
