...
/**
 * Spring Data JPA repository for the GrupoetnicoEntity entity.
 *
 ...
 */
@Repository
public interface GrupoetnicoRepository extends JpaRepository<GrupoetnicoEntity, Integer> {

	// Insert specific finders here 

	//List<GrupoetnicoEntity> findByXxx(String xxx);

	//List<GrupoetnicoEntity> findByXxxStartingWith(String xxx);

	//List<GrupoetnicoEntity> findByXxxContaining(String xxx);

	//List<GrupoetnicoEntity> findByYyy(BigDecimal yyy);

	//List<GrupoetnicoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
