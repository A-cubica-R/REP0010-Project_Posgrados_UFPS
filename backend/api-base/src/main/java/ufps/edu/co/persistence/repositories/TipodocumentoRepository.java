...
/**
 * Spring Data JPA repository for the TipodocumentoEntity entity.
 *
...
public interface TipodocumentoRepository extends JpaRepository<TipodocumentoEntity, Integer> {
	...
	//List<TipodocumentoEntity> findByXxx(String xxx);

	//List<TipodocumentoEntity> findByXxxStartingWith(String xxx);

	//List<TipodocumentoEntity> findByXxxContaining(String xxx);

	//List<TipodocumentoEntity> findByYyy(BigDecimal yyy);

	//List<TipodocumentoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
