...
/**
 * Spring Data JPA repository for the DepartamentoEntity entity.
 *
...
public interface DepartamentoRepository extends JpaRepository<DepartamentoEntity, Integer> {
	...
	List<DepartamentoEntity> findByIdPais(Integer idPais);

	// Insert specific finders here

	//List<DepartamentoEntity> findByXxx(String xxx);

	//List<DepartamentoEntity> findByXxxStartingWith(String xxx);

	//List<DepartamentoEntity> findByXxxContaining(String xxx);

	//List<DepartamentoEntity> findByYyy(BigDecimal yyy);

	//List<DepartamentoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
