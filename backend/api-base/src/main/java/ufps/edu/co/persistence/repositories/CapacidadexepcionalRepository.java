...
public interface CapacidadexepcionalRepository extends JpaRepository<CapacidadexepcionalEntity, Integer> {
	...
	//List<CapacidadexepcionalEntity> findByXxxStartingWith(String xxx);

	//List<CapacidadexepcionalEntity> findByXxxContaining(String xxx);

	//List<CapacidadexepcionalEntity> findByYyy(BigDecimal yyy);

	//List<CapacidadexepcionalEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
