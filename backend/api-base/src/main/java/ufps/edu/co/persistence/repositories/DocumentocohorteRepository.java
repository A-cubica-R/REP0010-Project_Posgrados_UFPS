...
/**
 * Spring Data JPA repository for the DocumentocohorteEntity entity.
 *
...
public interface DocumentocohorteRepository extends JpaRepository<DocumentocohorteEntity, Integer> {
	...
	//List<DocumentocohorteEntity> findByXxxStartingWith(String xxx);

	//List<DocumentocohorteEntity> findByXxxContaining(String xxx);

	//List<DocumentocohorteEntity> findByYyy(BigDecimal yyy);

	//List<DocumentocohorteEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
