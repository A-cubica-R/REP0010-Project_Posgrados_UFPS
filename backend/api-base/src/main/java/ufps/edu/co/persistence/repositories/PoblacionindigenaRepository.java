...
/**
 * Spring Data JPA repository for the PoblacionindigenaEntity entity.
 *
 ...
 */
@Repository
public interface PoblacionindigenaRepository extends JpaRepository<PoblacionindigenaEntity, Integer> {

	// Insert specific finders here 

	//List<PoblacionindigenaEntity> findByXxx(String xxx);

	//List<PoblacionindigenaEntity> findByXxxStartingWith(String xxx);

	//List<PoblacionindigenaEntity> findByXxxContaining(String xxx);

	//List<PoblacionindigenaEntity> findByYyy(BigDecimal yyy);

	//List<PoblacionindigenaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
