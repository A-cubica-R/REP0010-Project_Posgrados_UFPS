...
/**
 * Spring Data JPA repository for the DocumentosrequisitoconcejocohorteEntity entity.
 *
...
public interface DocumentosrequisitoconcejocohorteRepository extends JpaRepository<DocumentosrequisitoconcejocohorteEntity, Integer> {
	...
	//List<DocumentosrequisitoconcejocohorteEntity> findByXxx(String xxx);

	//List<DocumentosrequisitoconcejocohorteEntity> findByXxxStartingWith(String xxx);

	//List<DocumentosrequisitoconcejocohorteEntity> findByXxxContaining(String xxx);

	//List<DocumentosrequisitoconcejocohorteEntity> findByYyy(BigDecimal yyy);

	//List<DocumentosrequisitoconcejocohorteEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
