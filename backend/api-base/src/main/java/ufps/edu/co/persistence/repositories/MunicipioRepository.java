...
/**
 * Spring Data JPA repository for the MunicipioEntity entity.
 *
...
public interface MunicipioRepository extends JpaRepository<MunicipioEntity, Integer> {
	...
	List<MunicipioEntity> findByIdDepartamento(Integer idDepartamento);

	// Insert specific finders here

	//List<MunicipioEntity> findByXxx(String xxx);

	//List<MunicipioEntity> findByXxxStartingWith(String xxx);

	//List<MunicipioEntity> findByXxxContaining(String xxx);

	//List<MunicipioEntity> findByYyy(BigDecimal yyy);

	//List<MunicipioEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
