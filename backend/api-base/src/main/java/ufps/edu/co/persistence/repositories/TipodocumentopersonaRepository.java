...
/**
 * Spring Data JPA repository for the TipodocumentopersonaEntity entity.
 *
 ...
 */
@Repository
public interface TipodocumentopersonaRepository extends JpaRepository<TipodocumentopersonaEntity, Integer> {

	// Insert specific finders here 

	//List<TipodocumentopersonaEntity> findByXxx(String xxx);

	//List<TipodocumentopersonaEntity> findByXxxStartingWith(String xxx);

	//List<TipodocumentopersonaEntity> findByXxxContaining(String xxx);

	//List<TipodocumentopersonaEntity> findByYyy(BigDecimal yyy);

	//List<TipodocumentopersonaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
