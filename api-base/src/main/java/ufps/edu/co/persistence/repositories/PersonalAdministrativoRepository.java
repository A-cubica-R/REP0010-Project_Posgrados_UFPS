...
/**
 * Spring Data JPA repository for the PersonalAdministrativoEntity entity.
 *
 ...
 */
@Repository
public interface PersonalAdministrativoRepository extends JpaRepository<PersonalAdministrativoEntity, Integer> {

	// Insert specific finders here 

	//List<PersonalAdministrativoEntity> findByXxx(String xxx);

	//List<PersonalAdministrativoEntity> findByXxxStartingWith(String xxx);

	//List<PersonalAdministrativoEntity> findByXxxContaining(String xxx);

	//List<PersonalAdministrativoEntity> findByYyy(BigDecimal yyy);

	//List<PersonalAdministrativoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
