...
/**
 * Spring Data JPA repository for the RolEntity entity.
 *
...
public interface RolRepository extends JpaRepository<RolEntity, Integer> {
	...
	//List<RolEntity> findByXxxStartingWith(String xxx);

	//List<RolEntity> findByXxxContaining(String xxx);

	//List<RolEntity> findByYyy(BigDecimal yyy);

	//List<RolEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
