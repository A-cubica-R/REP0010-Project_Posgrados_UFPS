...
/**
 * Spring Data JPA repository for the TipoentrevistaEntity entity.
 *
...
public interface TipoentrevistaRepository extends JpaRepository<TipoentrevistaEntity, Integer> {
	...
	//List<TipoentrevistaEntity> findByXxxStartingWith(String xxx);

	//List<TipoentrevistaEntity> findByXxxContaining(String xxx);

	//List<TipoentrevistaEntity> findByYyy(BigDecimal yyy);

	//List<TipoentrevistaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
