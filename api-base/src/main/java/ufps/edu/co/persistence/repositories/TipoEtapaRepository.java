...
/**
 * Spring Data JPA repository for the TipoEtapaEntity entity.
 *
 ...
 */
@Repository
public interface TipoEtapaRepository extends JpaRepository<TipoEtapaEntity, Integer> {

	// Insert specific finders here 

	//List<TipoEtapaEntity> findByXxx(String xxx);

	//List<TipoEtapaEntity> findByXxxStartingWith(String xxx);

	//List<TipoEtapaEntity> findByXxxContaining(String xxx);

	//List<TipoEtapaEntity> findByYyy(BigDecimal yyy);

	//List<TipoEtapaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
