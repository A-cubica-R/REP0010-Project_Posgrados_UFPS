...
/**
 * Spring Data JPA repository for the DocumentoRequeridoOfertaEntity entity.
 *
 ...
 */
@Repository
public interface DocumentoRequeridoOfertaRepository extends JpaRepository<DocumentoRequeridoOfertaEntity, Integer> {

	// Insert specific finders here 

	//List<DocumentoRequeridoOfertaEntity> findByXxx(String xxx);

	//List<DocumentoRequeridoOfertaEntity> findByXxxStartingWith(String xxx);

	//List<DocumentoRequeridoOfertaEntity> findByXxxContaining(String xxx);

	//List<DocumentoRequeridoOfertaEntity> findByYyy(BigDecimal yyy);

	//List<DocumentoRequeridoOfertaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
