...
/**
 * Spring Data JPA repository for the HistorialEstadoDocumentoEntity entity.
 *
 ...
 */
@Repository
public interface HistorialEstadoDocumentoRepository extends JpaRepository<HistorialEstadoDocumentoEntity, Integer> {

	// Insert specific finders here 

	//List<HistorialEstadoDocumentoEntity> findByXxx(String xxx);

	//List<HistorialEstadoDocumentoEntity> findByXxxStartingWith(String xxx);

	//List<HistorialEstadoDocumentoEntity> findByXxxContaining(String xxx);

	//List<HistorialEstadoDocumentoEntity> findByYyy(BigDecimal yyy);

	//List<HistorialEstadoDocumentoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
