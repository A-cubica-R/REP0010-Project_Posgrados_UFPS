...
/**
 * Spring Data JPA repository for the DocumentoIdentidadEntity entity.
 *
 ...
 */
@Repository
public interface DocumentoIdentidadRepository extends JpaRepository<DocumentoIdentidadEntity, Integer> {

	// Insert specific finders here 

	//List<DocumentoIdentidadEntity> findByXxx(String xxx);

	//List<DocumentoIdentidadEntity> findByXxxStartingWith(String xxx);

	//List<DocumentoIdentidadEntity> findByXxxContaining(String xxx);

	//List<DocumentoIdentidadEntity> findByYyy(BigDecimal yyy);

	//List<DocumentoIdentidadEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
