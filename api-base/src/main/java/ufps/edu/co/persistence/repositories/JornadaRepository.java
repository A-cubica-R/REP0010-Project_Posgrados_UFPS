...
/**
 * Spring Data JPA repository for the JornadaEntity entity.
 *
...
public interface JornadaRepository extends JpaRepository<JornadaEntity, Integer> {
	...
	//List<JornadaEntity> findByXxx(String xxx);

	//List<JornadaEntity> findByXxxStartingWith(String xxx);

	//List<JornadaEntity> findByXxxContaining(String xxx);

	//List<JornadaEntity> findByYyy(BigDecimal yyy);

	//List<JornadaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
