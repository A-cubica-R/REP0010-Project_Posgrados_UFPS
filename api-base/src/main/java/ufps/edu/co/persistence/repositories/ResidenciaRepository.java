...
/**
 * Spring Data JPA repository for the ResidenciaEntity entity.
 *
 ...
 */
@Repository
public interface ResidenciaRepository extends JpaRepository<ResidenciaEntity, Integer> {

	// Insert specific finders here 

	//List<ResidenciaEntity> findByXxx(String xxx);

	//List<ResidenciaEntity> findByXxxStartingWith(String xxx);

	//List<ResidenciaEntity> findByXxxContaining(String xxx);

	//List<ResidenciaEntity> findByYyy(BigDecimal yyy);

	//List<ResidenciaEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
