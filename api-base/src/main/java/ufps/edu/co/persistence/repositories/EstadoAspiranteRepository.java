...
/**
 * Spring Data JPA repository for the EstadoAspiranteEntity entity.
 *
 ...
 */
@Repository
public interface EstadoAspiranteRepository extends JpaRepository<EstadoAspiranteEntity, Integer> {

	// Insert specific finders here 

	//List<EstadoAspiranteEntity> findByXxx(String xxx);

	//List<EstadoAspiranteEntity> findByXxxStartingWith(String xxx);

	//List<EstadoAspiranteEntity> findByXxxContaining(String xxx);

	//List<EstadoAspiranteEntity> findByYyy(BigDecimal yyy);

	//List<EstadoAspiranteEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
