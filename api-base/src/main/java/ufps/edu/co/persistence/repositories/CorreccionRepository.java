...
/**
 * Spring Data JPA repository for the CorreccionEntity entity.
 *
 ...
 */
@Repository
public interface CorreccionRepository extends JpaRepository<CorreccionEntity, Integer> {

	// Insert specific finders here 

	//List<CorreccionEntity> findByXxx(String xxx);

	//List<CorreccionEntity> findByXxxStartingWith(String xxx);

	//List<CorreccionEntity> findByXxxContaining(String xxx);

	//List<CorreccionEntity> findByYyy(BigDecimal yyy);

	//List<CorreccionEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
