...
/**
 * Spring Data JPA repository for the TipoTituloEntity entity.
 *
 ...
 */
@Repository
public interface TipoTituloRepository extends JpaRepository<TipoTituloEntity, Integer> {

	// Insert specific finders here 

	//List<TipoTituloEntity> findByXxx(String xxx);

	//List<TipoTituloEntity> findByXxxStartingWith(String xxx);

	//List<TipoTituloEntity> findByXxxContaining(String xxx);

	//List<TipoTituloEntity> findByYyy(BigDecimal yyy);

	//List<TipoTituloEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
