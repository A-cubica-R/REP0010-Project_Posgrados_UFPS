...
/**
 * Spring Data JPA repository for the ProgramaPosgradoEntity entity.
 *
 ...
 */
@Repository
public interface ProgramaPosgradoRepository extends JpaRepository<ProgramaPosgradoEntity, Integer> {

	// Insert specific finders here 

	//List<ProgramaPosgradoEntity> findByXxx(String xxx);

	//List<ProgramaPosgradoEntity> findByXxxStartingWith(String xxx);

	//List<ProgramaPosgradoEntity> findByXxxContaining(String xxx);

	//List<ProgramaPosgradoEntity> findByYyy(BigDecimal yyy);

	//List<ProgramaPosgradoEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
