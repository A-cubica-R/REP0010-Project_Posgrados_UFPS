...
/**
 * Spring Data JPA repository for the TituloEntity entity.
 *
...
public interface TituloRepository extends JpaRepository<TituloEntity, Integer> {
	...
	//List<TituloEntity> findByXxx(String xxx);

	//List<TituloEntity> findByXxxStartingWith(String xxx);

	//List<TituloEntity> findByXxxContaining(String xxx);

	//List<TituloEntity> findByYyy(BigDecimal yyy);

	//List<TituloEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
