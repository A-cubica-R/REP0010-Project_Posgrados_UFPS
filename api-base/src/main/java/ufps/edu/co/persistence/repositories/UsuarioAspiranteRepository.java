...
/**
 * Spring Data JPA repository for the UsuarioAspiranteEntity entity.
 *
 ...
 */
@Repository
public interface UsuarioAspiranteRepository extends JpaRepository<UsuarioAspiranteEntity, Integer> {

	// Insert specific finders here 

	//List<UsuarioAspiranteEntity> findByXxx(String xxx);

	//List<UsuarioAspiranteEntity> findByXxxStartingWith(String xxx);

	//List<UsuarioAspiranteEntity> findByXxxContaining(String xxx);

	//List<UsuarioAspiranteEntity> findByYyy(BigDecimal yyy);

	//List<UsuarioAspiranteEntity> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
