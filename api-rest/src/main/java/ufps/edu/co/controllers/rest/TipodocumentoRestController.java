...
import ufps.edu.co.processor.TipodocumentoProcessor;
import ufps.edu.co.records.input.TipodocumentoInput.*;
import ufps.edu.co.records.output.TipodocumentoOutput;
