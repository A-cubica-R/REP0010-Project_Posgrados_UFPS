...
public class FacultadRestController {
    ...
    public ResponseEntity<List<FacultadDTO>> findAll() {
        List<FacultadDTO> list = service.findAll();
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<FacultadDTO> findById(@PathVariable int id) {
        FacultadDTO facultadDTO = service.findById(id);
        if ( facultadDTO != null ) {
            return ResponseEntity.ok(facultadDTO); // 200 OK
        } else {
    ...
    public ResponseEntity<FacultadDTO> create(@RequestBody FacultadDTO facultadDTO) {
        FacultadDTO created = service.create(facultadDTO);
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<FacultadDTO> update(@PathVariable int id, @RequestBody FacultadDTO facultadDTO) {
        try {
            FacultadDTO updated = service.update(id, facultadDTO);
