...
import ufps.edu.co.processor.TipoentrevistaProcessor;
import ufps.edu.co.records.input.TipoentrevistaInput.*;
import ufps.edu.co.records.output.TipoentrevistaOutput;
