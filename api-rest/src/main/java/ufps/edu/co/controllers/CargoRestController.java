...
public class CargoRestController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CargoDTO> findById(@PathVariable int id) {
        CargoDTO cargoDTO = service.findById(id);
        if ( cargoDTO != null ) {
            return ResponseEntity.ok(cargoDTO); // 200 OK
        } else {
    ...
    public ResponseEntity<CargoDTO> create(@RequestBody CargoDTO cargoDTO) {
        CargoDTO created = service.create(cargoDTO);
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<CargoDTO> update(@PathVariable int id, @RequestBody CargoDTO cargoDTO) {
        try {
            CargoDTO updated = service.update(id, cargoDTO);
