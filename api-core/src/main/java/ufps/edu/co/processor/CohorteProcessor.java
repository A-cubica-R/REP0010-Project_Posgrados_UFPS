...
import ufps.edu.co.records.input.CohorteInput.COHORTE_CREATE;
import ufps.edu.co.records.input.CohorteInput.COHORTE_DELETE;
import ufps.edu.co.records.input.CohorteInput.COHORTE_FIND;
import ufps.edu.co.records.input.CohorteInput.COHORTE_PATCH;
import ufps.edu.co.records.input.CohorteInput.COHORTE_UPDATE;
